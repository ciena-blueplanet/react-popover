  ...
  _createClass(Popover, [{
    ...
    value: function animateExit() {
      ...
      this.exitingAnimationTimer2 = setTimeout(function () {
        setTimeout(function () {
          ...
          if (_this2.props.slide) {
            switch (_this2.props.place) {
              case "left":
                {
                  _this2.containerEl.style.transform = "scaleX(0)";
                  break;
                }
              ...
              default:
                {
                  _this2.containerEl.style.transform = "scaleY(0)";
                }
            }
          } else {
    ...
    value: function render() {
      ...
      var popover = this.state.exited ? null : _react2.default.createElement(
        ...
        _react2.default.createElement(Tip, { direction: faces[standing], size: tipSize })
      );
