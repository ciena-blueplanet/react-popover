...
var Popover = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    Tip: _propTypes.PropTypes.func,
    appendTarget: _propTypes.PropTypes.string,
    ...
    slide: _propTypes.PropTypes.bool,
    ...
    this.exitingAnimationTimer2 = setTimeout(function () {
      setTimeout(function () {
        if (_this.props.slide) {
          switch (_this.props.place) {
            case "left":
              {
                _this.containerEl.style.transform = "scaleX(0)";
                break;
              }
  ...
  renderLayer: function renderLayer() {
    ...
    return _reactDomFactories2.default.div(popoverProps, _reactDomFactories2.default.div.apply(_reactDomFactories2.default, [{ className: "Popover-body" }].concat(_toConsumableArray(popoverBody))), (0, _react.createElement)(this.props.Tip, tipProps));
  },
